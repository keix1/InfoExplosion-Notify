...
class GoogleSearch:
    ...
    def search_news(self, query='keyword'):
        self.query = query
        self.query_url = 'http://www.google.co.jp/search?hl=jp&num=' + str(self.page_num) + '&q=' + self.query + '&tbm=nws'
